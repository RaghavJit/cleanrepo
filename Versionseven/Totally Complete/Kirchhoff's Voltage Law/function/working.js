...
check.onclick = function MyCheck() {
    ...
    if ((arrChk.length == 8) &&(check_conns == 16)  && (instance.getAllConnections().length == 8)) {
...
r1val.oninput = function fill1() {
    tIR1.value = r1val.value + 'V';
    flags4 = 1;
    //updateAmmeters();
}

r2val.oninput = function fill2() {
    tIR2.value = r2val.value + 'V';
    flags4 = 1;
    //updateAmmeters();
}

r3val.oninput = function fill3() {
    tIR3.value = r3val.value + 'V';
    flags4 = 1;
    //updateAmmeters();
}
